...
(function () {
  ...
  const T = {
    en: {
      ...
      heroSubtitle: "Pentest Workbench",
    ...
    tr: {
      allCommands: "Tüm Komutlar", favorites: "Favoriler", search: "Komut ara...",
      newCategory: "+ Yeni Kategori", exportBtn: "Dışa Aktar", importBtn: "İçe Aktar",
      commands: "komut", categories: "kategori", subcategories: "alt kategori",
      noResults: "Komut bulunamadı", tryDiff: "Farklı anahtar kelimeler deneyin.",
      searchResults: "Arama Sonuçları", matching: "eşleşen",
      catName: "Kategori Adı", catIcon: "İkon (emoji)", catDesc: "Açıklama",
      subName: "Alt Kategori Adı", cmdTitle: "Komut Başlığı", cmdDesc: "Açıklama",
      cmdCommands: "Komut(lar)", cmdTags: "Etiketler", cmdNote: "Not (isteğe bağlı)",
      perLine: "Satır başına bir komut. Değişkenler için <PLACEHOLDER> kullanın.",
      tagComma: "essential, tool, advanced (virgül ile ayırın)",
      cancel: "İptal", save: "Kaydet", addSub: "+ Alt", addCmd: "+ Cmd",
      edit: "Düzenle", del: "Sil", copy: "Kopyala", copied: "Kopyalandı!",
      confirmDelCat: "Bu kategori ve içindeki tüm komutlar silinsin mi?",
      confirmDelSub: "Bu alt kategori silinsin mi?", confirmDelCmd: "Bu komut silinsin mi?",
      fillVars: "Değişkenleri Doldur", applyCopy: "Uygula ve Kopyala",
      notePlaceholder: "Notlarınızı buraya yazın...",
      heroSubtitle: "Sızma Testi Tezgâhı",
      heroDesc: "Sızma testi komutlarının saldırı aşamalarına göre düzenlenmiş kapsamlı bir koleksiyonu. Sertifika hazırlığı ve etik güvenlik değerlendirmeleri için.",
      educational: "Sadece eğitim amaçlıdır.", useResp: "Sorumlu ve etik kullanın.",
      machines: "Makineler", addMachine: "+ Yeni Makine", noMachines: "Henüz makine yok",
      addMachineDesc: "Hedef makineleri, servisleri, kimlik bilgilerini ve ilerlemeyi takip edin.",
      machineName: "Makine Adı", machineIP: "IP Adresi", machineOS: "İşletim Sistemi",
      ...
      newSub: "Yeni Alt Kategori", netErr: "Ağ hatası — sunucu çalışıyor mu?",
      copyFail: "Kopyalama başarısız", termCopied: "Terminal formatında kopyalandı!",
      playbook: "Playbook", applyPlaybook: "Uygula", progress: "İlerleme",
      currentPhase: "Mevcut aşama", nextSteps: "Sonraki adımlar", allDone: "Tamamlandı!",
      hosts: "Makineler", addHost: "+ Makine", owned: "Ele geçirildi", attackPath: "Saldırı Yolu",
      noHosts: "Henüz ek makine yok. Domain / ağ makinelerini buraya ekleyin.",
      replacePlaybook: "Mevcut kontrol listesi bu playbook'la değiştirilsin mi? Mevcut ilerleme kaybolur.",
      copyCmd: "Komutu kopyala", defaultChecklist: "Varsayılan liste",
      wuTemplate: "Şablon", wuMachine: "Makine bağla", wuSection: "Bölüm",
      history: "Geçmiş", noHistory: "Henüz kopyalanan komut yok.",
      clearHistory: "Temizle", copyAll: "Tümünü kopyala", paletteHint: "Komut ve eylem ara…", goto: "Git",
      engagement: "Operasyon", connections: "Bağlantılar", fromMachine: "Makineden ekle…",
      ...
      mTagsHint: "HTB, Linux, web (virgül ile ayırın)",
      diff_easy: "Kolay", diff_medium: "Orta", diff_hard: "Zor", diff_insane: "Çok Zor",
      stNotStarted: "Başlanmadı", stInProgress: "Devam ediyor", stOwned: "Ele geçirildi", stReported: "Raporlandı",
      statTotal: "Toplam", statOwned: "Ele geçirilen", statInProgress: "Devam eden", statAvg: "Ort. ilerleme",
      mSearch: "Makine ara…", filterAll: "Tümü", filterPlatform: "Platform", filterStatus: "Durum", filterTag: "Etiket",
      sortRecent: "Güncel", sortName: "İsim", sortProgress: "İlerleme", noMatches: "Filtrelerle eşleşen makine yok.",
      userFlag: "User flag", rootFlag: "Root flag", capture: "Yakala", capturedAt: "Yakalandı", notCaptured: "Yakalanmadı",
      flags: "Bayraklar", genWriteup: "Write-up oluştur", wuGenerated: "Write-up oluşturuldu",
      filledFrom: "Değişkenler dolduruldu:", machineNoIp: "Bu makinenin IP'si yok — önce IP girin.",
      dragHint: "İpucu: bir düğümü sürükleyerek yeniden konumlandırabilirsiniz.",
      detailTab: "Detay", reportTab: "Rapor", saveAsWriteup: "Write-up olarak kaydet",
      reportLive: "Bu rapor makinenin güncel verisinden canlı üretilir. Dışa aktarabilir ya da düzenlenebilir bir write-up olarak kaydedebilirsiniz.",
      loading: "Yükleniyor…", loadErrTitle: "Sunucuya ulaşılamadı", loadErrBody: "Uygulama verilerinizi yükleyemedi. Sunucunun çalıştığından emin olun ve tekrar deneyin.", retry: "Tekrar dene",
      svcScanHint: "Bu port için servis taraması kopyala", delItem: "Maddeyi kaldır", jumpMachine: "Makine", jumpWriteup: "Write-up",
      copyPhaseCmds: "Aşama komutlarını kopyala", noPhaseCmds: "Bu aşamada komut yok",
      started: "Başlatıldı", ownedAtLbl: "Ele geçirilme", elapsed: "Geçen süre", timeToOwn: "Ele geçirme süresi",
      exportMachineMd: "MD Aktar", addChecklistItem: "+ Madde ekle", customItemPh: "Özel kontrol maddesi…",
      // — Write-ups round 3 (ASCII-safe TR) —
      writeups: "Write-up'lar", writeupsDesc: "Pentest bulgularınızı ve write-up'larınızı belgeleyin. Açmak için tıklayın.",
      newWriteup: "+ Yeni Write-up", wuSearch: "Write-up ara…", wuSort: "Sırala",
      wuSortRecent: "En yeni", wuSortTitle: "Başlık", wuSortWords: "Kelime sayısı",
      wuAllTags: "Tüm etiketler", wuNoMatch: "Filtrelerle eşleşen write-up yok.",
      wuCount: "write-up", wuTotalWords: "toplam kelime", wuWords: "kelime", wuMin: "dk okuma",
      wuPin: "Sabitle", wuUnpin: "Sabitlemeyi kaldır", wuEmptyTitle: "Henüz write-up yok", wuEmptyBody: "İlk write-up'ınızı oluşturun.",
      wuNewTitle: "Yeni Write-up", wuTitleLabel: "Başlık", wuTitlePh: "Write-up başlığı...", wuStartBlank: "Boş belge",
      wuExportHtml: "HTML Aktar", wuCopyRendered: "Biçimlendirilmiş kopyala",
      wuRelatedMachine: "İlgili makine", wuOpenMachine: "Makineyi aç",
      wuEditTags: "Etiketleri Düzenle", confirmDelWriteup: "Bu write-up silinsin mi?", back: "Geri", imageBtn: "Görsel", wuTags: "Etiketler",
      // — Round 5: yapilandirilmis makine calisma alani —
      svcPort: "Port", svcProto: "Proto", svcName: "Servis", svcVersion: "Sürüm", svcState: "Durum", svcInfo: "Not",
      svcAdd: "+ Servis", svcNone: "Henüz servis yok. Satır ekleyin ya da nmap çıktısı aktarın.",
      importNmap: "nmap aktar", importNmapTitle: "nmap çıktısı aktar", importNmapPh: "`nmap -sCV`/`-sV` çıktısını yapıştırın. Port, servis ve sürümler otomatik ayrıştırılır.",
      importDo: "Ayrıştır ve ekle", importedN: "{n} servis aktarıldı", importedNone: "Bu çıktıda servis bulunamadı",
      rawToggle: "Ham", tableToggle: "Tablo", scanPort: "Bu portu tara", scanAll: "Tüm portları tara",
      credUser: "Kullanıcı", credSecret: "Parola/Sır", credTypeCol: "Tür", credSource: "Kaynak", credWorks: "Geçerli olduğu", credState: "Durum",
      credAdd: "+ Kimlik", credNone: "Henüz kimlik bilgisi yok.",
      credCopyUser: "Kullanıcıyı kopyala", credCopySecret: "Sırrı kopyala", credCopyPair: "user:pass kopyala",
      timeline: "İşlem Zaman Çizelgesi", timelineNone: "Henüz işlem yok. Bu makine aktif hedefken kopyaladığınız komutlar buraya otomatik işlenir.",
      timelineAdd: "+ Kayıt ekle", timelineNotePh: "Manuel kayıt — bulgu, karar, kilometre taşı…", clearTimeline: "Temizle",
      tlCmd: "komut", tlNote: "not", tlEvent: "olay", confirmClearTl: "Bu makinenin zaman çizelgesi temizlensin mi?",
      activeTarget: "Aktif hedef", setActive: "Aktif hedef yap", unsetActive: "Aktif hedefi kaldır",
      activeBadge: "AKTİF", activeHint: "Kopyalanan komutlar bu makineye işlenir.", activeNowSet: "Aktif hedef ayarlandı — kopyalar artık buraya işlenir",
      evidence: "Kanıt", evidenceNone: "Henüz ekran görüntüsü yok. Kanıt eklemek için bir görseli yapıştırın (Ctrl+V) ya da sürükleyin.",
      evidenceCaption: "Açıklama…", evidenceDrop: "Ekran görüntüsünü buraya yapıştırın ya da sürükleyin", evidenceDel: "Görüntüyü kaldır",
      boardView: "Pano", gridView: "Izgara", colDrop: "Buraya bırak",
      cvssCalc: "CVSS 3.1", cvssTitle: "CVSS 3.1 Temel Skor", cvssInsert: "Write-up'a ekle", cvssVector: "Vektör", cvssScore: "Skor", cvssSeverity: "Önem",
      profiles: "Profiller", profileSave: "Profil olarak kaydet", profileNew: "Profil adı (ör. Aktif Makine)", profileNone: "Kayıtlı profil yok", profileApply: "Uygula", profileDel: "Profili sil", profileSaved: "Profil kaydedildi",
      basket: "Script sepeti", basketAdd: "Sepete ekle", basketNone: "Sepet boş. Script oluşturmak için komut ekleyin.", basketCopy: "Script'i kopyala", basketClear: "Temizle", basketExport: ".sh aktar", basketTitle: "Script Sepeti", basketAdded: "Sepete eklendi", basketCount: "sepette",
      // — Round 6: ATT&CK etiketleri + referanslar —
      attackFacet: "ATT&CK", attackAll: "Tüm teknikler", cardRefs: "Referanslar", attackTitle: "MITRE ATT&CK tekniği",
      cmdAttack: "MITRE ATT&CK (isteğe bağlı)", cmdAttackHint: "ör. T1059, T1003.001 (virgül ile ayırın)", cmdRefs: "Referans bağlantıları (isteğe bağlı)", cmdRefsHint: "Her satıra bir URL (HackTricks, GTFOBins, doküman…)",
      // — Kayit gostergeleri —
      ...
      mColFlags: "Flag", mColPhase: "İlerleme", noIp: "IP yok", credOk: "geçerli",
      introTitle: "Ne için geldin?",
      introSub: "Birini seç — bunu bir kez sorar, sonra yoluna çıkmaz.",
      introBoxTitle: "Kutu çöz", introBoxDesc: "Bir oturum başlat. Preset seç — lab kutusu, OSCP+, OSWE, CKS — metodolojiyi adım adım yürütür, flag ve süre tutar, raporu yaptıklarından yazar.",
      introNextTitle: "Tıkandım", introNextDesc: "Elindekini söyle — açık portlar, kimlik bilgin var mı, neredesin — 5040 komut içinden sırada ne denenmeli sıralasın.",
      introBrowseTitle: "Bir şeye bakacağım", introBrowseDesc: "Komut referansının kendisi. 53 kategori, anında arama, favoriler ve kopyaladığın her komuta hedefini yazan doldurma çubuğu.",
      introLocal: "tamamen tarayıcında çalışır", introSkip: "geç",
      cmdOut: "Beklenen çıktı", cmdOutHint: "Çalıştığında neye benzediği — gerçek bir çalıştırmadan kısaltılmış örnek yapıştır.",
      navLayer: "ATT&CK katmanı", navDone: "teknik dışa aktarıldı",
      navNoTimeline: "Bu makine için kayıtlı komut yok — aktif hedef yapıp birkaç komut kopyala.",
      navNoMatch: "Kayıtlı komutların hiçbiri korpustaki bir tekniğe eşleşmiyor.",
      wuColTitle: "Write-up", wuColTags: "Etiket", wuColUpdated: "Güncelleme", wuColLength: "Uzunluk",
      nextMove: "Sıradaki Hamle", nextUnavailable: "Sıradaki Hamle kurulu değil. Etkinleştirmek için public/nextmove.js ekleyin.",
      examMode: "Oturumlar", examUnavailable: "Oturumlar kurulu değil. Etkinleştirmek için public/session.js ekleyin."
    }
  };
...
`
  ...
  function renderWriteupsPage() {
    ...
    list.forEach(wu => {
      ...
      del.className = "wu-file-delete"; del.appendChild(icon("trash"));
  ...
  function openCvssCalc(onInsert) {
    ...
    panel.innerHTML = '<div class="cvss-head"><h3>' + t("cvssTitle") + '</h3><button class="cvss-close" aria-label="Close">' + iconHtml("x") + '</button></div>';
  ...
  function renderMachinesPage() {
    ...
    function renderGrid() {
      ...
      list.forEach(m => {
        ...
        const cAct = document.createElement("td"); cAct.className = "col-act";
        const del = document.createElement("button"); del.className = "machine-del-btn"; del.appendChild(icon("trash"));
  ...
  function buildEvidenceSection(m) {
    ...
    function renderGrid() {
      ...
      m.evidence.forEach((ev, i) => {
        ...
        const del = document.createElement("button"); del.className = "evidence-del"; del.appendChild(icon("x")); del.title = t("evidenceDel"); del.addEventListener("click", () => { m.evidence.splice(i, 1); persist(); renderGrid(); });
  ...
  function renderMachineDetail(m) {
    ...
    if (total > 0) {
      ...
      groupByPhase(m.checklist).forEach(g => {
        ...
        g.items.forEach(({ item, i }) => {
          ...
          const del = document.createElement("button"); del.className = "checklist-item-del"; del.appendChild(icon("x")); del.title = t("delItem"); del.setAttribute("aria-label", t("delItem"));
    ...
    noteSection.innerHTML = '<h3>' + iconHtml("note") + ' ' + t("notes") + '</h3>';
  ...
  function buildSidebar() {
    ...
    // All
    mkNavItem(iconHtml("list"), t("allCommands"), s.tc, activeCategory === null && activeCategory !== "favs", () => { activeCategory = null; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    // Favorites
    const favCount = getFavCommands().length;
    mkNavItem(iconHtml("star"), t("favorites"), favCount, activeCategory === "favs", () => { activeCategory = "favs"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    ...
    mkNavItem(iconHtml("arrow-right"), t("nextMove"), nextLabel, activeCategory === "next", () => { activeCategory = "next"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    ...
    mkNavItem(iconHtml("target"), t("examMode"), sessLabel, activeCategory === "exam", () => { activeCategory = "exam"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    // Write-ups
    mkNavItem(iconHtml("file"), "Write-ups", writeups.length, activeCategory === "writeups", () => { activeCategory = "writeups"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    // Machines
    mkNavItem(iconHtml("server"), t("machines"), machines.length, activeCategory === "machines", () => { activeCategory = "machines"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    mkNavItem(iconHtml("clock"), t("history"), cmdHistory.length, activeCategory === "history", () => { activeCategory = "history"; searchQuery = ""; searchInput.value = ""; render(); closeMobile(); });
    // Categories
  ...
  function mkNavItem(icon, text, count, active, onClick) {
    ...
    // Two kinds of icon reach this: a sprite <svg> built by iconHtml() from a
    // literal in this file, and a category emoji out of seed.js. The first must
    // go in as markup, the second is user data and must not — so the test is on
    // the literal prefix, never on anything the data could fake.
    const iconMarkup = typeof icon === "string" && icon.slice(0, 5) === "<svg " ? icon : escapeHtml(icon);
    item.innerHTML = '<span class="nav-item-icon" aria-hidden="true">' + iconMarkup + '</span><span class="nav-item-text">' + escapeHtml(text) + '</span><span class="nav-item-count">' + count + '</span>';
  ...
  function renderCard(cmd, catId, subIdx, cmdIdx) {
    ...
    hdr.innerHTML = '<div class="cmd-title">' + hl(cmd.title) + '</div>' +
      ...
      '<button class="cmd-action-btn fav-btn' + (fav ? " fav-active" : "") + '" data-fav="' + escapeHtml(cmd.id || "") + '" title="Favorite">' + iconHtml("star") + '</button>' +
      '<button class="cmd-action-btn edit-btn" title="Edit">' + iconHtml("pencil") + '</button>' +
      '<button class="cmd-action-btn delete-btn" title="Delete">' + iconHtml("x") + '</button></div>';
  ...
  function renderCat(cat, catIdx) {
    ...
    function fillCatContent() {
      ...
      notes.forEach(note => {
        ...
        const noteDelBtn = document.createElement("button"); noteDelBtn.className = "note-delete-btn"; noteDelBtn.appendChild(icon("trash")); noteDelBtn.title = "Delete";
      ...
      cat.subcategories.forEach((sub, subIdx) => {
        ...
        // Not one of the 320 subcategory names is actually translated: 108 carry no
        // name_tr at all and the other 212 carry a byte-identical copy of the English
        // name. Under <html lang="tr"> the uppercase on .subcategory-title is applied
        // with Turkish casing, which maps i to a dotted capital — and 255 of those
        // names contain an i, so "System Reconnaissance" rendered as "SYSTEM
        // RECONNAİSSANCE". Tag the span with the language the text is really in,
        // decided by the text rather than by which field it came out of. A name_tr
        // that genuinely differs from the English keeps Turkish casing.
        const nameLang = (lang === "tr" && subName === sub.name) ? " lang=\"en\"" : "";
        subH.innerHTML = '<span' + nameLang + '>' + escapeHtml(subName) + '</span><div class="sub-actions"><button class="sub-action-btn" data-act="cmd">' + t("addCmd") + '</button><button class="sub-action-btn" data-act="edit">' + iconHtml("pencil") + '</button><button class="sub-action-btn delete-btn" data-act="del">' + iconHtml("x") + '</button></div>';
  ...
  // ── Icons ───────────────────────────────────────────────────────────────
  // The sprite lives in index.html; these are the two ways to reach it. Prefer
  // icon() — it returns a node, so there is no markup string to get wrong.
  // iconHtml() exists for the handful of places that still build innerHTML, and
  // takes no user input by design: `name` is always a literal in this file.
  function icon(name, cls) {
    // The namespace is inlined rather than hoisted to a const: a function
    // declaration hoists, a `const` does not, and these are called from the
    // IIFE's own load-time wiring — which sits above this point in the file.
    const NS = "http://www.w3.org/2000/svg";
    const svg = document.createElementNS(NS, "svg");
