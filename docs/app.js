  ...
  function renderCat(cat, catIdx) {
    ...
    function fillCatContent() {
      ...
      cat.subcategories.forEach((sub, subIdx) => {
        ...
        subH.innerHTML = '<span>' + escapeHtml(subName) + '</span><div class="sub-actions"><button class="sub-action-btn" data-act="cmd">' + t("addCmd") + '</button><button class="sub-action-btn" data-act="edit">' + iconHtml("pencil") + '</button><button class="sub-action-btn delete-btn" data-act="del">' + iconHtml("x") + '</button></div>';
