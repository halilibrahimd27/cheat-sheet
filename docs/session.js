...
(function () {
  ...
  var STR = {
    ...
    tr: {
      sessions: "Oturumlar", loading: "Oturum verisi yükleniyor…",
      loadFail: "Oturum verisi yüklenemedi.",
      loadFailHint: "session-data.js çevrimdışı kullanım için önbelleğe alınır — bu cihazdaki ilk ziyaretse bir kez çevrimiçi olmalısınız.",
      retry: "Yeniden dene", pickPreset: "Bir ön ayar seçin", pickHint: "Ön ayar bu ekranda ne göreceğini belirler. Süresi ve puanı olmayan ön ayarlarda ikisi de görünmez.",
      resume: "Devam eden", resumeOne: "Devam et", del: "Sil", start: "Başla",
      targetsKind: "Hedefler", tasksKind: "Görevler",
      noTimer: "süre yok, puan yok", noScore: "puan yok", noTimerOnly: "süre yok",
      toPass: "geçme puanı", passUndisclosed: "geçme puanı sağlayıcı tarafından açıklanmadı",
      pointsFromPanel: "puanlar Sınav Kontrol Panelinizden gelir",
      derivedTotal: "toplam eklediğin görevlerden türetilir",
      hours: "sa", mins: "dk", tasksN: "görev",
      cockpit: "Kokpit", report: "Rapor", retro: "Değerlendirme", rules: "Temel kurallar", keys: "Tuşlar",
      endSession: "Oturumu bitir", back: "Geri", elapsed: "Geçen", remaining: "Kalan",
      reportDue: "Rapor teslimi", overdue: "SÜRESİ GEÇTİ", clockNotStarted: "Başlamadı",
      startClock: "Sayacı başlat", startClockHint: "Sen söylemeden hiçbir şey işlemez.",
      score: "Puan", captured: "alındı", objectives: "hedef",
      routeTitle: "Geçme puanına en ucuz yol",
      routeReached: "Geçme puanı mevcut yakalamalarla sağlandı.",
      routeShort: "Kalan tüm bayraklar bile şu kadar eksik kalıyor:",
      routeOr: "veya en az bayrakla:",
      routeNeed: "Hâlâ gereken",
      budgets: "Takip ettiğin kotalar", budgetUsed: "kullanıldı", budgetAdvisory: "Yalnızca kaydettiklerini sayar. Burada hiçbir şey seni engellemez.",
      budgetReset: "sıfırlama", budgetPlus: "Bir tane kaydet", budgetMinus: "Birini geri al",
      targets: "Hedefler", tasks: "Görevler", addTarget: "+ Hedef ekle", addTask: "+ Görev ekle",
      noMachine: "Bağlı makine yok", linkMachine: "Makine bağla", createMachine: "Oluştur ve bağla",
      openMachine: "Makineler'de aç", machineName: "Makine adı",
      onTarget: "hedefte", phase: "Aşama", flags: "Bayraklar",
      enumQueue: "Keşif kuyruğu", enumEmpty: "Henüz kayıtlı servis yok.",
      enumImport: "nmap çıktını makine sayfasında içe aktar — kuyruk kendini ondan kurar.",
      enumNoProbe: "Bu portlar için keşif seti yok",
      enumConditional: "koşullu", enumShowCond: "Koşullu komutları göster",
      enumHideCond: "Koşullu komutları gizle", copyAll: "Her zaman çalıştırılan seti kopyala",
      copy: "Kopyala", copied: "Kopyalandı", note: "Not",
      enumQueueShort: "Kuyruk", checklist: "Rehber", stuck: "Tıkandın mı?", stuckClose: "Kapat",
      gStepOf: "adım", gPhaseOf: "/", gGoal: "Hedef", gPrev: "Önceki", gNext: "Sonraki aşama",
      gDone: "Tamamlanan", gLater: "Sırada", gAllDone: "Tüm aşamalar tamam",
      gAdvanced: "Aşama bitti — geçildi:", gReopen: "yeniden aç",
      stuckIntro: "Sırayla oku. Seni ilk rahatsız eden madde doğru olandır.",
      stuckMeta: "Hedef ne olursa olsun",
      stuckNone: "Bu odak ve aşama için hazır liste yok.",
      stuckList: "Liste", osLinux: "Linux", osWindows: "Windows",
      captureFlag: "Yakala", capturedAt: "Yakalandı", uncapture: "Geri al",
      flagValue: "Bayrak değeri", howCaptured: "Bunu nasıl elde ettin?",
      viaWeb: "Web arayüzü üzerinden", viaShell: "Kabuk üzerinden",
      evidenceReq: "Bu sayılmadan önce gereken kanıt",
      evidenceNone: "Bu ön ayar bu bayrak için kanıt şartı koymuyor.",
      official: "resmi", inferred: "çıkarım",
      officialTip: "Sağlayıcı bunu yayınladı.", inferredTip: "Daha genel bir kuraldan çıkarılmıştır. Sağlayıcı metni değildir.",
      unmetWarn: "şart işaretlenmedi. Eksik kanıt sıfır puan getirebilir.",
      captureAnyway: "Yine de yakala", overrodeAt: "Eksik şartlarla yakalandı olarak kaydedildi",
      attempts: "Denemeler", attemptsHint: "Denediğin her şey için bir satır. 18. saatteki sen bunu okuyacak.",
      attemptAdd: "Ne denedin? (Eklemek için Enter)", attemptWhy: "Neden başarısız oldu / ne öğretti (isteğe bağlı)",
      outFail: "başarısız", outPartial: "kısmi", outOk: "çalıştı",
      attemptsEmpty: "Henüz kayıt yok.", attemptsAll: "Tümü", attemptFilter: "Denemeleri filtrele",
      context: "Bağlam", contextConfirm: "Bağlamı onayla", contextConfirmed: "Bağlam onaylandı",
      contextBanner: "GEÇERLİ BAĞLAM", contextNone: "bağlam ayarlanmadı",
      contextWarn: "Bu göreve dokunmadan önce bağlamı ayarla ve onayla.",
      contextGaps: "Bağlam hiç onaylanmadı",
      contextDiff: "Bu görev, en son onayladığından farklı bir bağlam bildiriyor.",
      taskBudget: "Bütçe", taskSpent: "harcanan", taskStart: "Başla", taskStop: "Duraklat",
      taskVerify: "Doğrulama", taskVerifyHint: "Bunun gerçekten bittiğini hangi komut kanıtlıyor? Çalıştır, sonra işaretle.",
      taskVerified: "Doğrulandı", taskApplied: "Uygulandı", taskTodo: "Başlamadı", taskSkipped: "Atlandı", taskFailed: "Başarısız",
      flagReview: "Gözden geçirmek için işaretle", appFeatureNote: "Uygulama özelliği, sınav arayüzü özelliği değil",
      domainEst: "Ağırlıklı alan tahmini", domainEstHint: "Kendi görev-alan eşlemen, yayınlanan müfredat ağırlıklarıyla. Tahmindir, puan değildir.",
      domains: "alan", domainUntouched: "dokunulmadı", legendVerified: "doğrulandı", legendApplied: "uygulandı, doğrulanmadı", legendLost: "atlandı", legendOpen: "açık",
      timeSavers: "Zaman kazandıranlar", allowedDocs: "İzin verilen dokümantasyon", pitfalls: "Tuzaklar",
      notAllowed: "İZİN YOK", preflight: "Ön hazırlık ve son tarama",
      notes: "Bu ön ayar hakkında notlar", unverified: "Doğrulanmayanlar", sources: "Kaynaklar",
      honestyIntro: "Aşağıdaki her şey kaynağındaki hâliyle gösterilir. Sağlayıcının yayınlamadığı hiçbir şey tahmin edilmez.",
      advisoryTitle: "Araç kısıtlamaları (yol gösterici)",
      advisoryBody: "Bu, sağlayıcının yayınladığıdır. Kapsayıcı değildir ve bir aracın listede olmaması izin anlamına gelmez. Bu uygulama sana bir aracın güvenli olduğunu söylemez.",
      reportOrder: "Sınav kılavuzunun istediği gibi değerlendirme sırasına göre belgelenir.",
      reportBuild: "Rapor oluştur", reportSave: "Write-ups'a kaydet", reportUpdate: "Kayıtlı yazıyı güncelle",
      reportSaved: "Write-ups'a kaydedildi", reportOpen: "Write-ups'ı aç", reportCopy: "Markdown kopyala",
      saving: "kaydediliyor…", saved: "kaydedildi", saveFail: "kaydedilmedi — yeniden dene",
      saveFull: "kaydedilmedi — tarayıcı depolaması dolu",
      saveRetry: "Yeniden kaydet", loadDocFail: "Kayıtlı oturumların okunamadı. Hiçbir şey değiştirilmedi.",
      docFail: "Kayıtlı oturumlar okunamadı.",
      docFailHint: "Sorun GET /api/exam isteğinde, komut derlemesinde değil — ön ayarlar sorunsuz yüklendi. Sunucunun erişilebilir olduğunu doğrulayıp yeniden deneyin; hiçbir şey yazılmadı.",
      keysTitle: "Oturum tuşları", keysHint: "Uygulamanın kendi tuşları (Ctrl+K, /, g h, ?) çalışmaya devam eder.",
      keysWhenTargets: "Hedefe özel tuşlar, bu oturuma bir hedef eklendiğinde görünür.",
      keysWhenTasks: "Göreve özel tuşlar, bu oturuma bir görev eklendiğinde görünür.",
      confirmEnd: "Bu oturum bitirilsin mi? Listede kalır ve tekrar açılabilir.",
      confirmDel: "Bu oturum ve içindeki her şey silinsin mi?",
      yes: "Evet", no: "Vazgeç", done: "Bitti", reopen: "Tekrar aç",
      of: "/", perTask: "görev başına", derivedBy: "Bu uygulama tarafından ön ayardan türetildi — yayınlanmış bir değer değil.",
      sweepReserve: "son tarama payı", noBudget: "Bu ön ayar görev sayısı yayınlamıyor, bu yüzden türetilecek bir görev bütçesi yok."
    }
  };
